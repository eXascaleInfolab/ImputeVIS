      ...
      <div class="col-lg-12">
        <div class="row me-1">
          <form ref="ref_reload" @submit.prevent="submitForm">
            <div class="justify-content-left" style="padding: 10px; position: absolute; z-index: 100;">
...
export default {
  ...
  components: {
    ...
    const chartOptionsOriginal = ref(generateChartOptionsLarge('Data Contamination', 'Data'));
