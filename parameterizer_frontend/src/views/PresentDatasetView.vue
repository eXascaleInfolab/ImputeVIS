...
export default defineComponent({
  setup() {
    const datasets = [
      {id: 'drift', title: 'Drift', source: 'University of California, ChemoSignals', link: 'https://archive.ics.uci.edu/dataset/270/gas+sensor+array+drift+dataset+at+different+concentrations', timeSeries: '100', timeSeriesLength : "1000"},
      {id: 'bafu', title: 'BAFU', source: 'Swiss Federal Office for the Environment (FOEN)', link: 'https://www.hydrodaten.admin.ch/en', timeSeries: '10', timeSeriesLength : "50000"},
